...
func convertRSAPrivateKeyToStr(privateKey crypto.PrivateKey) string {
...
func TestGenerateKeyPair(t *testing.T) {
	...
	fmt.Printf("private key %s", convertRSAPrivateKeyToStr(sshKey.PrivateKey))
}
...
func TestReadKeyPair(t *testing.T) {
	...
	privateKey := convertRSAPrivateKeyToStr(sshKey.PrivateKey)
